...
export class ApiService {
  ...
  async getWarga(kd_pnddk: string): Promise<any> {
    try {
  ...
  async getPayment(kd: string, year: string, jenis: string) : Promise<any>{
    try {
      let url =
  ...
  async getPesan(kd_pnddk: string): Promise<any> {
    try {
  ...
  async insertIuran(data: any): Promise<any> {
    try {
