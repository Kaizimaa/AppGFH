...
@Component({
  selector: 'app-form-riwayat',
  templateUrl: './form-riwayat.page.html',
  styleUrls: ['./form-riwayat.page.scss'],
})
export class FormRiwayatPage {
  public Data: any;
  public listKas: any[] = [];
      ...
      if (val == null) {
        ...
        if (this.searchYear == '') {
          this._apiService.getKeluarga(val).then((res) => {
            this._apiService
              .getPayment(res.data.kd_blok, this.currentYear, 'Lainnya')
              .then((res) => {
                if (res?.msg == 'ok') {
                  this.Data = res?.data;
                  loader.dismiss();
          ...
          this._apiService.getKeluarga(val).then((res) => {
            this._apiService
              .getPayment(res.data.kd_blok, this.searchYear, 'Lainnya')
              .then((res) => {
                if (res?.msg == 'ok') {
                  this.Data = res?.data;
                  loader.dismiss();
