...
@Component({
  selector: 'app-edakun',
  templateUrl: './edakun.page.html',
  styleUrls: ['./edakun.page.scss'],
})
export class EdakunPage implements OnInit {
  public email: string = '';
      ...
      this.storage.get('isLoggedIn').then(async (val) => {
        if (val == null) {
          ...
          const res = await axios.get(
            this._apiService.uriApi + 'user?nik=' + val
          );
          if (res.data !== null) {
