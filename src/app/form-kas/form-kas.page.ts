...
@Component({
  selector: 'app-form-kas',
  templateUrl: './form-kas.page.html',
  styleUrls: ['./form-kas.page.scss'],
})
export class FormKasPage {
    ...
    this.storage.get('isLoggedIn').then(async (val) => {
      if (val == null) {
        ...
        if (
          ...
          formData.append('nik', val.nik);
          formData.append('kd', val.kd_blok);
