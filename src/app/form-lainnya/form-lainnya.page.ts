...
@Component({
  selector: 'app-form-lainnya',
  templateUrl: './form-lainnya.page.html',
  styleUrls: ['./form-lainnya.page.scss'],
})
export class FormLainnyaPage {
  public Data: any;
  public listKas: any[] = [];
      ...
      if (val == null) {
        ...
        if (this.searchYear == '') {
          this._apiService.getKeluarga(val).then((res) => {
            this._apiService
              .getPayment(res.data.kd_blok, this.currentYear, 'KAS')
              .then((res) => {
                if (res?.msg == 'ok') {
                  this.Data = res?.data;
                  loader.dismiss();
          ...
          this._apiService.getKeluarga(val).then((res) => {
            this._apiService
              .getPayment(res.data.kd_blok, this.searchYear, 'KAS')
              .then((res) => {
                if (res?.msg == 'ok') {
                  this.Data = res?.data;
                  loader.dismiss();
